...
class Wow_List_Table extends WP_List_Table {
	...
	public function column_title( $item ) {
		...
		$title         = ! empty( $item['title'] ) ? $item['title'] : esc_attr__( 'Untitle', 'floating-button' );
		...
		$actions       = array(
			'edit'      => '<a href="' . esc_url( $edit_url ) . '">' . esc_attr__( 'Edit', 'floating-button' ) . '</a>',
			'duplicate' => '<a href="' . esc_url( $duplicate_url ) . '" style="color:green;">' . esc_attr__( 'Duplicate', 'floating-button' )
			               . '</a>',
			'delete'    => '<a href="' . esc_url( $delete_url ) . '" style="color:red;">' . esc_attr__( 'Delete', 'floating-button' ) . '</a>',
		);
	...
	private function table_data() {
		...
		if ( $result ) {
			foreach ( $result as $key => $value ) {
				...
				$title        = ! empty( $value->title ) ? $value->title :  esc_attr__( 'Untitle', 'floating-button' ) ;
	...
	public function get_bulk_actions() {
		$actions = array(
			'delete-items' => esc_attr__('Delate',  'floating-button'),
		);
