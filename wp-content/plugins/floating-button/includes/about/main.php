...
<div class="wrap full-width-layout">
    <div class="about-wrap">
        ...
        <h1><?php esc_attr_e( 'Welcome', 'floating-button' ); ?> </h1>

        <p class="about-text">
			<?php esc_attr_e( 'Congratulations! You are about to use one of the plugins from Wow-Company.', 'floating-button' ); ?>
        </p>
                    ...
                    <div class="theme-id-container">
                        ...
                        <div class="theme-actions">
							...
							<?php if ( ! empty( $value[4] ) ) : ?>
                                <a class="button button-primary" href="<?php echo esc_url( $value[4] ); ?>"
