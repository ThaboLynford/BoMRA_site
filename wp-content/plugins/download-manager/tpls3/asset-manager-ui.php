        ...
        <div class="panel-body">
            <div class="media well-sm well-file" style="margin: 0;padding: 0">
                ...
                <h3 style="display: inline-block;font-size: 12pt;letter-spacing: 0.5px;font-weight: 400;font-family: var(--wpdm-font)">
                   <img src="<?php echo WPDM_BASE_URL ?>assets/images/file-cog.svg" style="height: 20px" /> <?php echo __( "Digital Asset Manager", "download-manager" ) ?> <sup style="color: var(--color-info) !important;font-size: 10px;font-family: 'Overpass Mono', sans-serif !important;">BETA</sup>
                </h3>
                                ...
                                <div class="tab-content">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form id="sharelink_form" method="post" action="<?php echo admin_url('admin-ajax.php'); ?>">
                                                            <?php wp_nonce_field(NONCE_KEY, '__wpdm_newsharelink'); ?>
                                                            ...
                                                            <div class="panel panel-default">
                                                                ...
                                                                if(is_plugin_active('wpdm-custom-access-level/wpdm-custom-access-level.php')){ ?>
                                                                    ...
                                                                    <div class="panel-footer"><input id="maname" placeholder="Start typing to search members..." style="width: 100%" type="text" class="form-control"></div>
                                                            ...
                                                            <div class="text-right">
                                                                <button type="submit" id="create_sharelink" class="btn btn-info">Create</button>
                                                            </div>
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="comments">
                                        <div class="panel panel-default" id="newcomment_panel" style="margin: 10px 0;">
                                            ...
                                            <div class="panel-footer text-right" style="padding: 5px;"><button id="addcomment" :data-assetid="asset.ID" type="button" class="btn btn-sm btn-info">Add Comment</button></div>
                                        </div>
