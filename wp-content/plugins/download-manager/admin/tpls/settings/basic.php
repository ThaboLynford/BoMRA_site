...
*/ ?>
                    ...
                    <div class="panel-body">
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <label><input type="checkbox" name="__wpdm_recaptcha_loginform" value="1" <?php checked(1, get_option('__wpdm_recaptcha_loginform')); ?>> <?php echo __( "Enable login up form CAPTCHA validation" , "download-manager" ); ?></label>
                        </div>
                        </fieldset>
 ...
 <div class="panel panel-default">
     ...
     <div class="panel-body">
         ...
         <div class="form-group">
             <input type="hidden" name="__wpdm_ind_stats" value="0">
         ...
         <div class="form-group">
             ...
             <label><input type="checkbox" <?php checked(get_option('__wpdm_flat_download_url'),1); ?>  name="__wpdm_flat_download_url" value="1"> <?php _e( "Activate flat download url" , "download-manager" ); ?></label><br/>
