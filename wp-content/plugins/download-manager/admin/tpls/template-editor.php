...
?> 
    ...
    <tr valign="top" class="alternate author-self status-inherit" id="post-8">
                ...
                <input type="hidden" name="tplid" value="<?php echo isset($_GET['tplid'])?wpdm_query_var('tplid'):uniqid(); ?>" required="required">
              ...
              <?php //the_editor(stripslashes($tpl['content']),'tpl[content]','content', true, true); ?>                
                ...
                <input type="button" value="<?php echo __( "Save Template" , "download-manager" ); ?>" class="btn savetplbtn btn-primary">
