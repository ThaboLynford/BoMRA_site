...
$can_edit = (array_intersect($current_user->roles, get_option('__wpdm_front_end_admin', array()))) || $post->post_author == get_current_user_id() ? 1 : 0;
if ($can_edit) {
    ?>
    <div class="w3eden">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                <input id="title" class="form-control input-lg" placeholder="Enter title here"
                                       type="text"
                            ...
                            <div class="card "
                                ...
                                <div class="card-header"><b><?php _e("Package Settings", "download-manager"); ?></b>
                                </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card " id="categories-section"
                                 <?php if (in_array('cats', $hide)) { ?>style="display: none"<?php } ?>>
                            ...
                            <div class="card " <?php if (in_array('images', $hide)) { ?>style="display: none"<?php } ?>>
                                <div class="card-header"><b><?php _e("Main Preview Image", "download-manager"); ?></b>
                                </div>
