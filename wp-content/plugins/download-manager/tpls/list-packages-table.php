...
<div class="input-group input-group-lg input-group-x">
    <?php if($admin == 1){ ?>
    <a href="?adb_page=manage-packs" class="input-group-prepend __wpdm_load_async" data-container="#wpdm-package-list"><span class="input-group-text border-0">All Items</span></a>
    <a href="?adb_page=manage-packs&_author=<?php echo $current_user->ID ?>" class="input-group-prepend __wpdm_load_async" data-container="#wpdm-package-list"><span class="input-group-text border-0" style="border-left: 1px solid #ddd !important;border-right: 1px solid #ddd !important;z-index: 9;">My Items</span></a>
    <?php } ?>
    <input placeholder="<?php _e( "Search..." , "download-manager" ); ?>" type="text" id="sfld" class="form-control" name="q" value="<?php echo $Q; ?>"><div class="input-group-btn"><button class="btn btn-lg"><i class="fas fa-search color-green"></i></button></div>
</div>
