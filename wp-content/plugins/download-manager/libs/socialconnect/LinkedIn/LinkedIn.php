...
class LinkedIn
{
    ...
    public function getAuthUrl()
    {
        ...
        return "https://www.linkedin.com/oauth/v2/authorization?response_type=code&client_id=". $this->app_id . "&redirect_uri=".urlencode($this->callback) ."&state=". $this->csrf."&scope=". $this->scopes ;
    }
    ...
    public function getPerson($accessToken)
    {
        ...
        $user['first_name'] = $person->firstName->localized->en_US;
        $user['last_name'] = $person->lastName->localized->en_US;
