...
class Pagination{
                ...
                function show(){
                    ...
                    return wpdm_paginate_links( $this->total_pages, $this->limit, $this->page, 'cp', array('container' => '#'.$e_id, 'async' => (isset($this->async) && $this->async == 1 ? 1 : 0), 'next_text' => ' <i style="display: inline-block;width: 8px;height: 8px;border-right: 2px solid;border-top: 2px solid;transform: rotate(45deg);margin-left: -2px;margin-top: -2px;"></i> ', 'prev_text' => ' <i style="display: inline-block;width: 8px;height: 8px;border-right: 2px solid;border-bottom: 2px solid;transform: rotate(135deg);margin-left: 2px;margin-top: -2px;"></i> '));
