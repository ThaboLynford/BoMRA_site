...
class YasrProURIncludes {
    ...
    public function addShortcodes() {
        add_shortcode('yasr_pro_average_comments_ratings',
            array($this, 'averageCommentsRatings')
        );

        add_shortcode('yasr_pro_comments_ratings_progressbars',
            array('YasrProURShortcodes', 'averageCommentsRatingsProgressBars')
        );

    }

    public function averageCommentsRatings($atts, $content, $shortcode_tag=false) {
        $average_comments_obj = new YasrProURShortcodes($atts, $shortcode_tag);
        return $average_comments_obj->reviewsAverage();
    }
