            ...
            <div class="wpfd-toolbar-wrapper">
                <div class="wpfd-btn-toolbar" id="wpfd-toolbar">
                    <div class="btn-wrapper">
                        <button title="<?php esc_html_e('Cut', 'wpfd'); ?>" onclick="Wpfd.submitbutton('files.movefile')" class="btn btn-small" id="wpfd-cut">
                            <i class="wpfd-svg-icon-cut"></i>
                            <span><?php esc_html_e('Cut', 'wpfd'); ?></span></button>
                    </div>
                    <div class="btn-wrapper">
                        <button title="<?php esc_html_e('Copy', 'wpfd'); ?>" onclick="Wpfd.submitbutton('files.copyfile')" class="btn btn-small" id="wpfd-copy">
                            <i class="wpfd-svg-icon-copy"></i>
                            <span><?php esc_html_e('Copy', 'wpfd'); ?></span></button>
                    </div>
                    <div class="btn-wrapper">
                        <button title="<?php esc_html_e('Paste', 'wpfd'); ?>" onclick="Wpfd.submitbutton('files.paste')" class="btn btn-small" id="wpfd-paste">
                            <i class="wpfd-svg-icon-paste"></i>
                            <span><?php esc_html_e('Paste', 'wpfd'); ?></span></button>
                    </div>
                    <div class="btn-wrapper">
                        <button title="<?php esc_html_e('Delete', 'wpfd'); ?>" onclick="Wpfd.submitbutton('files.delete')" class="btn btn-small" id="wpfd-delete">
                            <i class="wpfd-svg-icon-trash"></i>
                            <span><?php esc_html_e('Delete', 'wpfd'); ?></span></button>
                    </div>
                    <div class="btn-wrapper">
                        <button title="<?php esc_html_e('Download', 'wpfd'); ?>" onclick="Wpfd.submitbutton('files.download')" class="btn btn-small" id="wpfd-download">
                            <i class="wpfd-svg-icon-download"></i>
                            <span><?php esc_html_e('Download', 'wpfd'); ?></span></button>
                    </div>
                    <div class="btn-wrapper">
                        <button title="<?php esc_html_e('Select all', 'wpfd'); ?>" onclick="Wpfd.submitbutton('files.selectall')" class="btn btn-small" id="wpfd-selectall">
                            <i class="wpfd-svg-icon-check-all"></i>
                            <span><?php esc_html_e('Select all', 'wpfd'); ?></span></button>
                    </div>
                    <div class="btn-wrapper">
                        <button title="<?php esc_html_e('Uncheck', 'wpfd'); ?>" onclick="Wpfd.submitbutton('files.uncheck')" class="btn btn-small" id="wpfd-uncheck">
                            <i class="wpfd-svg-icon-remove"></i>
                            <span><?php esc_html_e('Uncheck', 'wpfd'); ?></span></button>
                    </div>
                </div>
        ...
        <div id="rightcol" class="wpfd-column">
            <?php if (Utilities::getInput('caninsert', 'GET', 'bool')) : ?>
                <?php if (Utilities::getInput('woocommerce', 'GET', 'bool')) : ?>
                    <a id="insertfiletowoo" class="ju-button orange-outline-button" style="display: none;" href="#"
                       onclick="if (window.parent) insertFileToWoo();"><?php esc_html_e('Insert this file', 'wpfd'); ?></a>
                <?php else : ?>
                    <?php if (Utilities::getInput('elementorbuilder', 'GET', 'bool')) : ?>
                        <a id="insertcategory" class="ju-button orange-outline-button" href="#"
                           onclick="if (window.parent) insertElementorCategory();"><?php esc_html_e('Insert this category', 'wpfd'); ?></a>
                        <a id="insertfile" class="ju-button orange-outline-button" style="display: none;" href="#"
...
<!--                        <h4>--><?php //esc_html_e('Parameters', 'wpfd'); ?><!--</h4>-->
                    ...
                    <?php if (WpfdBase::loadValue($this->globalConfig, 'show_file_import', 0)) { ?>
                        <div class="well wpfdFileImporter">
                    ...
                    <div class="well">
                        ...
                        <div id="dropbox_version">
                            <div class="upload">
                                ...
                                <span id="upload_button_version" class="ju-button orange-outline-button">
...
function openItem($category, $key, $globalConfig)
{
    ...
    if (has_filter('wpfdAddonShowCategoryOneDriveBusiness', 'displayCategoriesOneDriveBusiness')) {
        $iconsCat .= apply_filters('wpfdAddonShowCategoryOneDriveBusiness', $category->term_id);
    }
    ...
    $item .= '<div class="dd-content dd3-content' . $disable . $dd_handle . '">';
