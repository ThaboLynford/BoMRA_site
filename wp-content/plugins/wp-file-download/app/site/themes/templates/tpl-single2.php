...
<div class="wpfd-single-file">
    ...
    <div class="wpfd-single-file--buttons">
        {{#if settings.download_button}}
            ...
            {{else}}
                <a href="{{file.linkdownload}}" data-id="{{file.ID}}" title="{{#if file.description}}{{file.description}}{{else}}{{file.title}}{{/if}}" class="noLightbox wpfd_downloadlink wpfd-single-file-button wpfd-button-download">
