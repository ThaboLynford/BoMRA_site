...
$possible_plugin_locations = array(
	...
	'C:\xampp\htdocs\bomra\wp-content\plugins\wp-optimize\cache',
);
...
if (false === $plugin_location) {
	...
	if (strcasecmp('https://localhost/bomra/', $protocol . '://' . $host . $request_uri) === 0) {
...
if (false !== $plugin_location) {
	...
	if (!defined('WPO_CACHE_EXT_DIR')) define('WPO_CACHE_EXT_DIR', 'C:\xampp\htdocs\bomra\wp-content\plugins\wp-optimize\cache/extensions');
}
